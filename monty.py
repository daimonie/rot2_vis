...
class Monty:
    ...
    def perturb(self):
        ...
        alea_flip = np.random.randint(0, high=4,size=1); 
        if alea_flip == 0:
	    ...
	    raise Exception("What magic is this?")
    ...
    def flip_r( self, xx, yy,zz ):
        ...
        energy_forward = self.forward_energy( xx, yy, zz, random_rotation, self.field_u[0][xx][yy][zz], self.field_u[1][xx][yy][zz], self.field_u[2][xx][yy][zz], ising);
        
        energy_difference =  energy_forward - self.site_energy[xx][yy][zz]  
        if self.accept(energy_difference): 
            ...
            self.site_energy[xx][yy][zz] = energy_forward
    ...
    def flip_u( self, xx, yy, zz, direction): 
        ...
        energy_forward = 0.0
        if direction == 0:
            energy_forward = self.forward_energy( xx, yy, zz, self.field_r[xx][yy][zz],  self.bath_u[alea] , self.field_u[1][xx][yy][zz], self.field_u[2][xx][yy][zz], self.field_s[xx][yy][zz]); 
        elif direction == 1:
            energy_forward = self.forward_energy( xx, yy, zz, self.field_r[xx][yy][zz],  self.field_u[0][xx][yy][zz] ,self.bath_u[alea], self.field_u[2][xx][yy][zz], self.field_s[xx][yy][zz]); 
        elif direction == 2:
            energy_forward = self.forward_energy( xx, yy, zz, self.field_r[xx][yy][zz],  self.field_u[0][xx][yy][zz] , self.field_u[1][xx][yy][zz], self.bath_u[alea], self.field_s[xx][yy][zz]); 
        else:
